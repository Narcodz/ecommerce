        ...
        <Layout title={'Forgot Password - Cakes n’ Sprinkles'}>
            <div className="form-container">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        <input type="text" value={answer} onChange={(e) => setAnswer(e.target.value)} className="form-control" id="exampleInputEmail" placeholder='Enter Your Favourite Sport Name' required />
                    </div>
                    <div className="mb-3">
